...
final class FileExplorerStateModePersistenceTests: XCTestCase {
    ...
    func testCLIArgumentNormalizerMapsVaultAndSessionsToSessions() {
        ...
        XCTAssertEqual(RightSidebarMode.from(cliArgument: "agent-queue"), .agentQueue)
        XCTAssertEqual(RightSidebarMode.from(cliArgument: "agentqueue"), .agentQueue)
        XCTAssertEqual(RightSidebarMode.from(cliArgument: "queue"), .agentQueue)
        XCTAssertEqual(RightSidebarMode.from(cliArgument: " Vault "), .sessions)
